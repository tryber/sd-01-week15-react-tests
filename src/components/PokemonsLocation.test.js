...
// import * as API from '../services/pokedexService';

const clear = () => afterEach(function () {
  cleanup();
});

// API.apiLocationPokemons = jest.fn(
//   () => new Promise((resolve) => setTimeout(() => resolve(dataOfComparition), 5000)),
// );
